...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-payment-firstname"), "Nishir");
        sendTextToElement(By.id("input-payment-lastname"), "CHita");
        sendTextToElement(By.id("input-payment-email"), "nishit@gmail.com");
        sendTextToElement(By.id("input-payment-telephone"), "07724584629");
        sendTextToElement(By.id("input-payment-address-1"), "4 cocksut street");
