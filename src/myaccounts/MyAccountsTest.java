...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        selectMyAccountOptions("Register");
        //Enter First Name
        sendTextToElement(By.id("input-firstname"), "Nishit");
        //Enter Last Name
        sendTextToElement(By.id("input-lastname"), "Chitaliya");
        //Enter Email
        ...
        //Enter Telephone
        sendTextToElement(By.id("input-telephone"), "07749147377");
        //Enter Password
        sendTextToElement(By.id("input-password"), "nishit8664");
        //Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "nishit8664");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        selectMyAccountOptions("Login");
        //Enter Email address
        sendTextToElement(By.id("input-email"), "nishitchitaliya@gmail.com");
        //Enter Password
        sendTextToElement(By.id("input-password"), "Nishit8664");
